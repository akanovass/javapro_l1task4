...
public class HelloServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<td><select name='user_food'><option>Manty - 900 KZT</option><option>Lagman - 1100 KZT </option><option> Plov - 800 KZT</option> </select></td>");
        out.println("</tr>");
        out.println("<tr>");
        out.println("<td></td>");
        ...
        out.println("<div class='row nt-3 mt-3'>");
        out.println("<div class='col-7 mx-auto' style='border: 1px #d1d1d1 solid; border-radius:7px; padding-top:10px;'>");
